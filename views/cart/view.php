                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="woocommerce">
                            <table class="shop_table shop_table_responsive cart">
                                ...
                                <?php foreach($session['cart'] as $id => $item):?>
                                    <tr>
                                        ...
                                        <td>
                                            <p><a href="<?= Url::to(['product/view', 'id' => $id])?>"><?= $item['name']?></a></p>
                                        </td>
                                        <td>
                                            <p><?= $item['price']?></p>
                                        </td>
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                <div class="coupon">
                                    <button type="button" class="button hb_coupon_btn" name="apply_coupon" onclick="clearCart()">Удалить все позиции</button>
                                </div>
                            </div>
                                ...
                                <div class="cart_totals">
                                    <div class="cart_total_inner">
                                        ...
                                        <div class="wc-proceed-to-checkout">
                                            <a href="<?= Url::to(['/cart/order'])?>" class="checkout-button hb_btn">Оформить заказ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
